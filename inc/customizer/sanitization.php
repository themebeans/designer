 ...
 */
function designer_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function designer_sanitize_css( $css ) {
 ...
 */
function designer_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function designer_sanitize_email( $email, $setting ) {
 ...
 */
function designer_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function designer_sanitize_html( $html ) {
 ...
 */
function designer_sanitize_image( $image, $setting ) {
 ...
 */
function designer_sanitize_nohtml( $nohtml ) {
 ...
 */
function designer_sanitize_number_absint( $number, $setting ) {
...
function designer_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 *                    the setting default.
 */
function designer_sanitize_number_range( $number, $setting ) {
 ...
 */
function designer_sanitize_select( $input, $setting ) {
 ...
 */
function designer_sanitize_url( $url ) {
